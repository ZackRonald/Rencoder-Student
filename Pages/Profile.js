  ...
  const fetchProfile = async () => {
    try {
      ...
      if (response.status === 200) {
        ...
        setProfileImage({
          uri: studPic ? `http://192.168.194.158:5000/${studPic}` : `http://192.168.194.158:5000/uploads/profile.png`
        });

        const isAllDataPresent = (studAddress && studAddress.trim() !== '') &&
          (degree && degree.trim() !== '') &&
      ...
      <Modal visible={isModalVisible} transparent={true} animationType="slide">
        <View style={styles.modalContainer}>
          ...
          <View style={styles.pickerContainer}>
            <Picker selectedValue={occp} onValueChange={handleOccupationChange} style={styles.picker}>
          ...
          {isDesgiInpVisible && (
            <TextInput placeholder="Designation" style={styles.input} value={desgi} onChangeText={setDesgi} />
          )}

          <TextInput style={styles.input} value={dob} onChangeText={setDob} placeholder="Enter DOB" />
